...
cat("pDNM:\n",
  ...
  "Number unique genes:",length(unique(pDNM$geneID)),"\n"
    )
pDNM <- melt(pDNM,id.vars=c("refseqID","geneID"),variable_name="class")
```
...
`r autismDeNovos$gene[!toupper(autismDeNovos$gene) %in% toupper(pDNM$geneID)]`
